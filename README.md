...
- [MCP Gateway](https://github.com/MikkoParkkola/mcp-gateway) - Rust-based MCP gateway with single-port multiplexing and a Meta-MCP pattern where 4 meta-tools replace 100+ tool registrations for ~95% context window savings. Features OpenAPI auto-import to capability YAML, hot-reloadable capabilities without restarting AI sessions, circuit breakers, and 42 starter capabilities (25 zero-config).
