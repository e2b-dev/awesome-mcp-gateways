...
- [MCP ContextForge](https://github.com/IBM/mcp-context-forge) - A secure, extensible MCP gateway with configurable plugins, delivering unified MCP, A2A, and REST discovery with built-in federation, access control, observability, rate limiting, virtual servers, and protocol translation.
