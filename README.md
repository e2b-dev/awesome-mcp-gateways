...
- [ToolRouter](https://toolrouter.com) - Give your AI agent 254 hosted tools through one MCP (`npx -y toolrouter-mcp`). Competitor research, video, web search, images, security scanning, flights, and more — toolrouter.com. Free tools work straight away; one connection replaces juggling dozens of provider accounts.
