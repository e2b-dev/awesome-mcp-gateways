...
- [ToolRouter](https://toolrouter.com) - The OpenRouter for tools: 254 hosted specialist tools through one MCP connection (search, scrape, SEO, image/video, research, security). Free tools work before account claim; pay per successful paid call.
