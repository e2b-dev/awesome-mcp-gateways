...
- [Marchward](https://github.com/marchward/marchward) - Open-source (Apache-2.0) MCP gateway that applies policy to tools/call: gate writes behind approval, block irreversible tools, audit every call.
